...
public class ConsistentHash<T> {
    ...
    public static void main(String[] args) {
        ...
        ConsistentHash<NodeBean> stringConsistentHash = new ConsistentHash<NodeBean>(numberOfReplicas,nodeList);

        Map<NodeBean, Integer> countMap = new HashMap<NodeBean,Integer>(){
            @Override
        ...
        for(int i=0;i<1000000;i++){
            NodeBean nodeBean = stringConsistentHash.get(i+"");
            System.out.println(i+"分配到" + nodeBean.getDbIp());
